...
impl_has_wire_object!(PrivateMessage, WelcomeMessage, ApprovalRequest);
...
impl ObjectBase for Object {
    fn context(&self) -> &Value {
        match self {
            ...
            Object::ApprovalRequest(v) => v.context(),
        }
    }
    ...
    fn actor(&self) -> &str {
        match self {
            ...
            Object::ApprovalRequest(v) => v.actor(),
        }
    }
